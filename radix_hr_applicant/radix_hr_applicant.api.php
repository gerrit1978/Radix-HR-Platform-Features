 ...
 */
function hook_radix_hr_applicant_private_fields_view_access($field, $profile, $account) {
 ...
 */
function hook_radix_hr_applicant_private_fields_info_text_alter(&$text, $field_name) {
